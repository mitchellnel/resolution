...
describe("CreateResolutionForm tests", () => {
  it("Create resolution title as bound data", () => {
    ...
    const titleInputElement = screen.getByTestId("create-resolution-form-title");
  ...
  it("Create resolution description as bound data", () => {
    render(<MockCreateResolutionForm />);
    const descriptionInputElement = screen.getByTestId("create-resolution-form-description");
