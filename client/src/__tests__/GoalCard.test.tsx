...
describe('GoalCard tests', () => {
  it('GoalCard displays description', () => {
    render(<GoalCard goal={mockIncompleteGoal} resolutionKey={mockResolutionKey} achieveGoal={mockAchieveGoal} setCompleted={mocksetCompleted}/>);
  ...
  it("GoalCard doesn't render OccurrenceCounter for complete goal", () => {
    render(<GoalCard goal={mockCompletedGoal} resolutionKey={mockResolutionKey} achieveGoal={mockAchieveGoal} setCompleted={mocksetCompleted}/>);
